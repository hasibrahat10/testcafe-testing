...
class FeedbackPage{
    ...
    formSubmitButton: Selector = Selector('input').withAttribute('value',
    'Send Message')
    ...
    async submitFeedback(t: TestController) {
        ...
        .typeText(this.formEmail, 'email@sdfsds.com', {paste: true, replace: true})
        .typeText(this.formSubject, 'subject', {paste: true, replace: true})
        .typeText(this.formComment, 'rmailss@sadfs.com', {paste: true, replace: true})
